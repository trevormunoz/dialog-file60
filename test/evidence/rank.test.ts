...
// column header, and one row per ranked term. Column character widths are this
// reconstruction's own choice (proto.rank.columns), not read from either source -- the same
// rule Task 2 applied to format 6's typeset worked output.
