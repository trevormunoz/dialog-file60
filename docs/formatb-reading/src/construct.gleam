...
fn parse_subcommodity(
  ...
  case segments_on_0x02(bytes) {
    [code_segment, literal_segment, percent] ->
      case
        drop_trailing_0xa0(code_segment),
...
fn segments_on_0x02(bytes: BitArray) -> List(BitArray) {
...
fn drop_trailing_0xa0(bytes: BitArray) -> Result(BitArray, Nil) {
